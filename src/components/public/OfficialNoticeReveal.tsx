      ...
      <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 sm:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-6 border-b border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-yellow-500 text-slate-950 flex items-center justify-center font-bold">
          ...
          {announcements.map((item, idx) => (
            ...
            >
              <div className="space-y-2.5">
                ...
                <h3 className="font-bold text-slate-900 dark:text-white text-base group-hover:text-yellow-600 dark:group-hover:text-yellow-400 transition-colors line-clamp-2">
                  {item.title}
                </h3>
              ...
              >
                <span>Baca Rincian Dokumen</span>
